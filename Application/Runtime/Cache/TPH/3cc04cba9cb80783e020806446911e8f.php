...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li><a href="/index.php/TPH/FCode"><i class="icon-tasks"></i>表单生成</a></li>
...
function getRelationCode(){	//获取手工关联代码
	...
	$.post("/index.php/TPH/MCode/relationshipModelCode", 
...
function creatRelationFile(){ //生成关联代码文件
	...
	var moduleName = $('#moduleName').val();
	var modelName =  $('#tableName1').val();
	$.post("/index.php/TPH/MCode/createRelationshipModelFile", {'code' : code, 'moduleName' : moduleName, 'modelName' : modelName},
	function(data){
...
function addRelationCode(){ //添加关联代码
	...
	$.post("/index.php/TPH/MCode/addRelationModelCode", 
		{'modelName' : modelName, 'mappingName' : mappingName, 'foreignKey' : foreignKey, 'relationForeignKey' : relationForeignKey,
		'mappingType' : mappingType, 'className' : className, 'relationTable' : relationTable, 'moduleName': moduleName},
		function(data){
...
function getViewCode(){	//生成视图模型代码
	...
	$.post("/index.php/TPH/MCode/viewModelCode", 
...
function addViewCode(){ //添加视图模型代码片段
	...
	$.post("/index.php/TPH/MCode/addViewModelCode", 
...
function createViewFile(){ //生成视图模型文件
	...
	var moduleName = $('#moduleName').val();
	var modelName =  $('#viewTable1').val();
	$.post("/index.php/TPH/MCode/createViewModelFile", {'code' : code, 'moduleName' : moduleName, 'modelName' : modelName},
	function(data){
...
function readOnColum(){
	...
	$.post("/index.php/TPH/MCode/readOnColum", 
...
jQuery(document).ready(function($) {
	...
	$('#tableName1').change(function(){
		...
		$.post("/index.php/TPH/MCode/getTableInfo", {'selectTableName' : selectTableName, 'label' : 'relation_foreign_key:'},
			function(data){
	...
	$('#tableName2').change(function(){
		...
		$.post("/index.php/TPH/MCode/getTableInfo", {'selectTableName' : selectTableName, 'label' : 'foreign_key:'},
			function(data){
	...
	*/
	...
	$('#viewTable1').change(function(){
		...
		$.post("/index.php/TPH/MCode/getViewTableInfo", {'selectTableName' : selectTableName, 'label' : 'field:'},
			function(data){
	...
	$('#viewTable2').change(function(){
		...
		$.post("/index.php/TPH/MCode/getViewTableInfo2", {'selectTableName' : selectTableName, 'label' : 'field:'},
			function(data){
